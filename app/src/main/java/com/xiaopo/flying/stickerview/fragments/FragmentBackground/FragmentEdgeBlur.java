...
public class FragmentEdgeBlur extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_background_edge_blur, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        cancel = getView().findViewById(R.id.cancel_edge_blur);
        accept = getView().findViewById(R.id.accept_edge_blur);
        intensity = getView().findViewById(R.id.intensity_edge_blur);
    ...
    public void onResume() {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentManager.beginTransaction().remove(FragmentEdgeBlur.this).commit();
        ...
        intensity.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                image_edit.setFilter(new GPUImageGaussianBlurFilter(progress/100.0f));
            }
