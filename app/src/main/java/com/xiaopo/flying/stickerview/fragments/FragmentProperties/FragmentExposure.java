...
public class FragmentExposure extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_properties_exposure, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        cancel = getView().findViewById(R.id.cancel_exposure);
        accept = getView().findViewById(R.id.accept_exposure);
        intensity = getView().findViewById(R.id.exposure_Intensity);
    ...
    public void onResume() {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentManager.beginTransaction().remove(FragmentExposure.this).commit();
        ...
        intensity.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                image_edit.setFilter(new GPUImageExposureFilter(progress/100.0f));
            }
