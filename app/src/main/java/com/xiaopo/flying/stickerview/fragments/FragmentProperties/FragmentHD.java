...
public class FragmentHD extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_properties_hd, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        cancel = getView().findViewById(R.id.cancel_hd);
        accept = getView().findViewById(R.id.accept_hd);
        intensity = getView().findViewById(R.id.intensity_hd);
    ...
    public void onResume() {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentManager.beginTransaction().remove(FragmentHD.this).commit();
        ...
        intensity.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                image_edit.setFilter(new GPUImageSharpenFilter(progress/100.0f));
            }
